...
<template>
  <input
    ...
    :class="cn('flex h-8 w-full rounded-sm border border-paper-300 bg-white px-2.5 text-sm text-ink-900 placeholder:text-ink-400 transition-colors duration-100 focus:border-brand-500 focus:outline-none focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50', props.class)"
