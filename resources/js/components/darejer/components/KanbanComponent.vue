        ...
        >
          ...
          >
            ...
            <div class="flex items-center gap-1.5">
              ...
              <span
                v-else
                class="inline-flex h-4 min-w-[1rem] items-center justify-center rounded-full px-1 text-[10px] font-semibold tabular-nums"
          ...
          >
            ...
            >
              ...
              <!-- Meta -->
              <div v-if="cardTpl.metaFields?.length" class="mb-1.5 flex flex-col gap-0.5">
                <div
