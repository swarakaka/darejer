...
const allowedTools = computed(() => props.component.toolbar as string[] | null | undefined)
  ...
  >
    <template #default="{ hasError }">
      ...
      >
        ...
        <div v-if="maxChars" class="darejer-rte-footer" :class="{ 'is-over-limit': isOverLimit }">
          {{ charCount }} / {{ maxChars }}
        </div>
      </div>
