...
const initialRaw = (props.formData ?? props.record)[props.component.name] ?? props.component.default ?? ''
...
const isRevealable = computed(() => props.component.inputType === 'password' && !!props.component.revealable)
