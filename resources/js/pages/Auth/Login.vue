  ...
  <div class="space-y-7 p-4">
    ...
    <form class="space-y-5" @submit.prevent="submit">
      ...
      <div class="flex flex-col gap-1.5">
        <div class="flex items-center justify-between">
          ...
          <Link
            ...
            class="text-brand-700 hover:text-brand-800 text-xs font-medium transition-colors hover:underline"
          >
            {{ __('Forgot password?') }}
          </Link>
        </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <Label for="remember" class="text-ink-600 cursor-pointer text-sm font-normal">
